                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                            ...
                            final adminProvider = Provider.of<AdminProvider>(
                                ...
                                listen: false);
                            final success =
                                await adminProvider.deleteReward(reward.id);
                ...
                child: Consumer<AdminProvider>(
                  builder: (context, adminProvider, child) {
                    if (adminProvider.isLoading &&
                        adminProvider.rewards.isEmpty) {
                      return const Center(
                        child: CircularProgressIndicator(
                          valueColor:
                              AlwaysStoppedAnimation<Color>(BrandColors.accent),
                        ),
                      );
                    }
...
class _AddEditRewardDialogState extends State<AddEditRewardDialog> {
  ...
  void initState() {
    ...
    _pointsController =
        TextEditingController(text: widget.reward?.costPoints.toString() ?? '');
    _imageUrlController =
                      ...
                      child: Consumer<AdminProvider>(
                        builder: (context, adminProvider, child) {
                          return Container(
                            ...
                            child: ElevatedButton(
                              onPressed:
                                  adminProvider.isLoading ? null : _saveReward,
                              style: ElevatedButton.styleFrom(
                                backgroundColor: Colors.transparent,
                                shadowColor: Colors.transparent,
                                padding:
