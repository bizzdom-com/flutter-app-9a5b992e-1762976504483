...
class _StaffScannerScreenState extends State<StaffScannerScreen> {
  ...
  Future<void> _handleScan(String qrCode) async {
    ...
    if (staffProvider.scannedCustomer == null &&
        staffProvider.scannedCoupon == null) {
        ...
        content: TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12),
              borderSide: BorderSide(color: BrandColors.info, width: 2),
            ),
            fillColor: BrandColors.neutralBase,
            filled: true,
          ),
        ),
        actions: [
  ...
  Future<void> _awardPoints(int points) async {
    ...
    try {
      final staffId =
          await StaffService.getStaffIdByUserId(authProvider.user!.id);
      if (staffId == null) {
                    ...
                    Column(
                      children: [
                        CircularProgressIndicator(
                          valueColor:
                              AlwaysStoppedAnimation<Color>(BrandColors.info),
                        ),
