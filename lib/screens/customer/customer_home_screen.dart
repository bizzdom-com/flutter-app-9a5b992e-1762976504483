...
class _CustomerHomeScreenState extends State<CustomerHomeScreen> {
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    ...
                                    boxShadow: [
                                      BoxShadow(
                                        color:
                                            BrandColors.info.withOpacity(0.3),
                                        blurRadius: 15,
                                        spreadRadius: -2,
                        ...
                        TextButton(
                          onPressed: () {
                            widget.onNavigateToTab
                                ?.call(3); // Navigate to History tab
                          },
                          style: TextButton.styleFrom(
                            foregroundColor: BrandColors.info,
                            padding: const EdgeInsets.symmetric(
  ...
  Widget _buildRecentActivity(
      BuildContext context, List<PointsLedgerModel> history) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: isEarn
                ? BrandColors.successBright.withOpacity(0.05)
                : BrandColors.pink.withOpacity(0.05),
            blurRadius: 10,
            spreadRadius: -2,
          ),
        ],
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: isEarn
                    ...
                    : [BrandColors.pink, BrandColors.pinkDeep],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              ...
              boxShadow: [
                BoxShadow(
                  color: (isEarn ? BrandColors.successBright : BrandColors.pink)
                      .withOpacity(0.3),
                  blurRadius: 8,
                  spreadRadius: -2,
                ),
